...
describe('exceptions', function(){
  ...
  it('should not demo __stack if compileDebug is false', function() {
    try {
...
describe('includes', function(){
  it('should demo ejs', function(){
    var file = 'test/fixtures/demo.ejs';
    ejs.render(fixture('demo.ejs'), { filename: file, pets: users, open: '[[', close: ']]' })
      .should.equal(fixture('demo.html'));
  })
  ...
  it('should demo arbitrary files as-is', function(){
    var file = 'test/fixtures/demo.css.ejs';
    ejs.render(fixture('demo.css.ejs'), { filename: file, pets: users })
      .should.equal(fixture('demo.css.html'));
  })

  it('should pass compileDebug to demo', function(){
    var file = 'test/fixtures/demo.ejs';
    var fn = ejs.compile(fixture('demo.ejs'), { filename: file, open: '[[', close: ']]', compileDebug: false, client: true })
    var str = fn.toString();
    eval('var preFn = ' + str);
